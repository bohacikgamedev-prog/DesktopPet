...
Clone or download the whole repo: git clone https://github.com/bohacikgamedev-prog/DesktopPet.git

Open DesktopPetVS.sln in Visual Studio.
...
Windows Defender might warn you – just allow it.
...
Right now it’s just the beginnings, but I’ll try to make it more fun and interactive.
